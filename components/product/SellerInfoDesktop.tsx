...
export default function SellerInfoDesktop({ announcement }: Props) {
  ...
  return (
    <div className="hidden w-[95%] flex-col items-center gap-3 border border-gray-600 bg-white p-7 xl:flex xl:w-[440px]">
